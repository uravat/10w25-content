...
You will need to submit these screenshots of the finished surveys through your `.Rmd` and knitted `.html` file as mentioned below. In the survey, you may indicate if you do not consent to use your answers in a research project. You may alternatively, pick an image of your choice and replace the required screenshot with your favorite image to complete this assignment.  
...
If you completed Survey 1, in the code chunk below, replace `screenshot_to_replace.png` to the filename of the screenshot for Survey 1 completion you saved to the screenshots folder in part (a).  Otherwise, include your favorite image. 
...
If you completed Survey 2, in the code chunk below, replace `screenshot_to_replace.png` to the filename of the screenshot for Survey 2 completion you saved to the screenshots folder in part (a). Otherwise, include your favorite image.
